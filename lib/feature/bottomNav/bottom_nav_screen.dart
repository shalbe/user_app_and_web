...
class BottomNavScreen extends StatefulWidget {
  ...
  final int pageIndex;
   const  BottomNavScreen({super.key, required this.pageIndex, this.previousAddress});
...
class _BottomNavScreenState extends State<BottomNavScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Obx(() => _bottomNavigationView(widget.previousAddress)),
      ),
    );
  }
  ...
  _bottomNavigationView(AddressModel? previousAddress) {
    PriceConverter.getCurrency();
    switch (Get.find<BottomNavController>().currentPage.value) {
      case BnbItem.home:
        return HomeScreen(addressModel: previousAddress);
