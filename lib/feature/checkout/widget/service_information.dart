            ...
            child: Center( child: Row(mainAxisAlignment:MainAxisAlignment.spaceBetween, crossAxisAlignment:CrossAxisAlignment.start, children: [
              Expanded( flex: 7,
                child: Column( mainAxisAlignment: MainAxisAlignment.spaceEvenly, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  addressModel!.contactPersonName != null && !addressModel.contactPersonName.toString().contains('null') ?
                  ...
                  addressModel.contactPersonNumber != null && !addressModel.contactPersonNumber.toString().contains('null') ?
                  Padding(
                  ...
                  addressModel.contactPersonName != null && addressModel.contactPersonNumber != null ?
