...
class RouteHelper {
  ...
  static String getMainRoute(String page,  {AddressModel? previousAddress}) {
    String data = '';
    if(previousAddress != null){
      List<int> encoded = utf8.encode(jsonEncode(previousAddress.toJson()));
      data = base64Encode(encoded);
    }
    return '$main?page=$page&address=$data';
  }
  ...
  static List<GetPage> routes = [
    GetPage(
      ...
      page: () => getRoute(ResponsiveHelper.isDesktop(Get.context)
          ...
          : const BottomNavScreen(pageIndex: 0, previousAddress: null)),
    ),
