...
enum DiscountType {general, coupon, campaign}
...
class CheckoutHelper {
  ...
  static double calculateGrandTotal({required List<CartModel> cartList}){
    return
  ...
  static double calculateDueAmount({required List<CartModel> cartList, required bool walletPaymentStatus, required double walletBalance, required double bookingAmount}){
    return calculateGrandTotal(cartList: cartList) - (walletPaymentStatus ? calculatePaidAmount(walletBalance: walletBalance, bookingAmount: bookingAmount) : 0);
  }
